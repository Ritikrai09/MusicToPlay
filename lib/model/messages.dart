class Messages {
  ...
  String? confirmExitTitle,poll,great,sendAgain,colorScheme,pleaseloginComment;
  String? bookmarkSave,bookmarkRemove,searchFieldEmpty,orSignIn,orSignUp,youHaveViewedAll,like,comment;
  String? minimum3Select,otpButton,openBrowser,seemsLikeNoInterests,copyLink,search,shareYourApp,popularNews,share;
  String? otpDescription,resendCodeIn,resendCode,loadingOTP,otpSent,otpVerified,otpExpired,quotes,seeAll,loadMore;
  
  String? commentHeader,pollTitle,youmightalso,noShortsDescription,shortsNav,
    noShortsTitle,postComment,commentUnderApproval,commentNotPosted;
  
  String? undoComment,commentReport,noMorePosts,nofeed,source,passwordRequired,commentCannotReport,undo,newpasswordAndConfirmPasswordNotSame,
  commentCannotDelete,delete,seemsLikeUnauthenticated,writeYourComment,exitmessageotp,exitOtp,
  somethingWentWrong,report,nextArticle,deleteCommentConfirm, previousArticle,getInTouch,send,messageRequired,message,scrollToTop,recentSearch,dontHaveAccount;
  ...
  Messages({
    ...
    this.newpasswordAndConfirmPasswordNotSame,
    this.source,
    this.dontHaveAccount,
    this.getInTouch,
    this.message,
    this.commentCannotDelete,
    this.commentCannotReport,
    this.undoComment,
    this.commentReport,
    this.undo,
    this.orSignIn,
    this.orSignUp,
    this.seemsLikeUnauthenticated,
    this.nofeed,
    this.seemsLikeNoInterests,
    this.send,
    this.scrollToTop,
    this.colorScheme,
    this.loadMore,
    ...
    this.postComment,
    this.commentUnderApproval,
    this.commentNotPosted,
    this.bookmarkRemove,
    this.bookmarkSave,
    this.youmightalso,
    this.quotes,
    ...
    this.adPage,
    this.showBanner,
    this.googleSignIn,this.appleSignIn,this.facebookSignIn,
  ...
  Messages.fromJson(Map<String, dynamic> json) {
    ...
    youmightalso = json['you_might_also'];
    ...
    writeYourComment = json['write_your_comment'];
    ...
    orSignUp = json['or_sign_up'];
    orSignIn = json['or_sign_in'];
    yes = json['app_yes'];
    ...
    newpasswordAndConfirmPasswordNotSame = json['newpassword_and_confirm_password_not_same'];
    featuredStories = json['app_featured_stories'];
    filterByTopics = json['Filter by topic'];
    myFeed = json['app_my_feed'];
    getInTouch = json['get_in_touch'];
    ...
    readFull = json['app_read_full'];
     commentCannotDelete  = json['comment_cannot_delete'];
     exitmessageotp  = json['exit_message_otp,'];
     exitOtp=json['exit_title_otp'];
    commentCannotReport = json['comment_cannot_report'];
    undoComment = json['undo_your_comment'];
    commentReport = json['comment_report'];
    undo = json['undo'];
    ...
    quotes = json['quotes'];
     ...
     commentUnderApproval = json['comment_under_approval'];
    commentNotPosted  = json['comment_not_posted'];

    colorScheme = json['color_scheme'];
    pollTitle= json['poll_title'];
    popularNews = json['app_all_news'];

    seeAll = json['see_all'];
    share = json['share'];
    pleaseloginComment=json['login_to_see_comments'];
    comment=json['comment'];
    commentHeader=json['comment_section'];
    postComment = json['comment_button'];
    like=json['like'];
    nocommentYet = json['no_comment_yet'];
    shareYourApp = json['share_your_app'];

    nofeed = json['no_feed'];
    seemsLikeUnauthenticated =  json['seems_like_unauthenticated'];
    seemsLikeNoInterests=json['seems_like_no_interests'];
    noShortsTitle = json['no_shorts_title'];
    noShortsDescription = json['no_shorts_description'];
    shortsNav = json['shorts_nav'];


    previousArticle = json["previous_article"];

    nextArticle = json["next_article"];
    deleteCommentConfirm = json['delete_comment_confirm'];
       }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    data['app_current_date'] = currentDate;
    data['seems_like_no_interests'] =  seemsLikeNoInterests;
    data['app_wrong_email_and_password'] = wrongEmailAndPassword;
    data['app_email_not_exist'] = emailNotExist;
    data['message_required'] = messageRequired;
    data['shorts_nav'] = shortsNav;
    data['login_to_see_comments']= pleaseloginComment;
    data['quotes'] = quotes;
    data['comment_button'] =  postComment;
    data['no_comment_yet']=nocommentYet;
    data['comment_header'] = commentHeader;

    data['write_your_comment'] = writeYourComment;
    data['share']=share;
    data['poll_title'] = pollTitle;
    data['comment']= comment;
    data['like'] = like;
    data['or_sign_up'] = orSignUp;
    data['source'] = source ;
    data['or_sign_in'] = orSignIn;
    data['dont_have_account'] = dontHaveAccount;
    data['seems_like_unauthenticated'] = seemsLikeUnauthenticated;
    data["undo_your_comment"] = undoComment;
    data[ "report"] =  report;
    data["delete"] =  delete;
    data[ "no_more_post" ]=  noMorePosts;
    data[ "scroll_to_top" ] = scrollToTop;

    data['see_all'] = seeAll; 
    data['no_feed'] = nofeed;
    data['you_might_also']=youmightalso;

    data['message'] = message;
    data['comment_under_approval'] = commentUnderApproval;
    data['comment_not_posted'] = commentNotPosted;
    data['something_went_wrong'] = somethingWentWrong;
    data['share_your_app']=shareYourApp;
    data['all_news'] = popularNews;
    ...
    data['newpassword_and_confirm_password_not_same'] = newpasswordAndConfirmPasswordNotSame;
    ...
    data['get_in_touch'] = getInTouch;
    data['recent_search'] = recentSearch;
    ...
    data['app_choose_your_language2'] = chooseYourLanguage2;
     data['delete_comment_confirm'] = deleteCommentConfirm;
    return data;
  }
}
