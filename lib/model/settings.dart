...
class SettingModel {
  ...
  String? oneSignalKey;
  String? googleApikey,androidRateUs,iosRateUs;
  bool? isVoiceEnabled;
  String? secondaryColor;
  String? localAppSplash;
  String? localAppLogo;
  String? localRectLogo;
  String? isEnableStories,isEnableSkip, isEnableSelectLanguage;
  String? androidSchema,iosSchema;
  ...
  SettingModel(
      ...
      this.secondaryColor,
      this.localAppSplash,
      this.isEnableStories,
      this.isEnableSkip, 
      this.isEnableSelectLanguage,
      this.localAppLogo,
      this.localRectLogo,
      this.appName,
  ...
  SettingModel.fromJson(Map<String, dynamic> json) {
    ...
    androidRateUs = json['android_rate_us'];
    iosRateUs = json['ios_rate_us'];
    androidSchema =json['android_schema'];
    iosSchema =json['ios_schema'];
    isEnableStories = json['enable_stories'];
    isEnableSkip = json['enable_skip'];
    isEnableSelectLanguage = json['enable_select_language_appear'];
    ...
    fbInterstitialIdIos = json['fb_ads_interstitial_id_ios'];
    siteTitle = json['site_title'];
    primaryColor=json['primary_color'];
    isVoiceEnabled = json['is_voice_enabled']== "1" || json['is_voice_enabled']== 1 ? true : false;
    ...
    localAppSplash  = prefs!.containsKey('splash_logo') ? prefs!.getString('splash_logo') : json['splash_logo'];
    localRectLogo  = prefs!.containsKey('rect_logo') ? prefs!.getString('rect_logo') : json['rect_logo'];
    localAppLogo = prefs!.containsKey('app_logo') ? prefs!.getString('app_logo') : json['app_logo'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['splash_logo'] = localAppSplash;
    data['rect_logo'] = localRectLogo;
    data['app_logo'] = localAppLogo;
